...
const numSchema = object({
  mobileNo: number()
    .required("Phone number is required")
    .positive()
    .integer("must be numeric"),
  // .integer("Input should consist 0-9 only"),
});
...
class HomePage extends Component {
  ...
  onNumchangeHandler = () => {
    this.setState({ VerificationPage: false });
  };
  ...
  generateOtp = async () => {
    try {
      ...
      let response = await fetch(
        "https://bhr-projects.cyclic.cloud/otp/generate/",
        {
          method: "GET",
          headers: headersList,
        }
  ...
  onVerificationOtp = async () => {
    const { otpInput, genratedOtp } = this.state;
    try {
      let headersList = {
        Accept: "*/*",
      ...
      let response = await fetch(
        "https://bhr-projects.cyclic.cloud/otp/verify",
        {
          method: "POST",
          body: bodyContent,
          headers: headersList,
      ...
      console.log(data);
      if (response.ok) {
        this.setState({ page: pageMode.SuccessPage });
      } else {
        Store.addNotification({
          title: "Invalid OTP",
        ...
        {page === pageMode.SuccessPage ? (
          ...
          <div className="home-container">
            ...
            <div className="about-container">
              ...
              <img
                src="https://mir-s3-cdn-cf.behance.net/projects/404/ef4db889812729.Y3JvcCwxMDgwLDg0NCwwLDgy.jpg"
                alt="img"
                className="about-img"
              />
            </div>
            <div className="login-section">
              {VerificationPage ? (
                <>
                  <p
                    style={{ margin: "0", fontSize: "20px", color: "#483287" }}
                  >
                  ...
                  <p>
                    ...
                    <button
                      ...
                      type="button"
                      onClick={this.onNumchangeHandler}
                    >
                      change
                    </button>
                  </p>
                  ...
                  >
                    {" "}
                    Verify <IoIosArrowDroprightCircle size={20} />{" "}
                  </button>
                </>
              ) : (
                <>
                    ...
                    validate={(values) => {
                      ...
                      if (!values.mobileNo) {
                        ...
                        if (
                          ...
                          errors.mobileNo =
                            "Phone number should consist 10 digits";
                        }
                      }
                      return errors;
                    }}
                  ...
                  >
                    {({
                      ...
                      <>
                        ...
                        >
                          {" "}
                          Continue <IoIosArrowDroprightCircle size={20} />{" "}
                        </button>
                      </>
                    )}
                  </Formik>
